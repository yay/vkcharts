...
import { VkChartThemePalette, VkChartThemeOptions, VkChartThemeOverrides } from "../vkChartOptions";
...
export class ChartTheme {
    ...
    readonly palette: VkChartThemePalette;
    ...
    private static cartesianSeriesTypes: (keyof VkChartThemeOverrides)[] = ['line', 'area', 'bar', 'column', 'scatter'];
