...
export type VkChartThemeName = 'vk-default' | 'vk-default-dark'
    | 'vk-material' | 'vk-material-dark'
    | 'vk-pastel' | 'vk-pastel-dark'
    | 'vk-solar' | 'vk-solar-dark'
    | 'vk-vivid' | 'vk-vivid-dark';
...
export interface VkNumberAxisThemeOptions extends Omit<VkNumberAxisOptions, 'type'>, VkCartesianAxisThemeOptions<VkNumberAxisOptions> {}
export interface VkLogAxisThemeOptions extends Omit<VkLogAxisOptions, 'type'>, VkCartesianAxisThemeOptions<VkLogAxisOptions> {}
export interface VkCategoryAxisThemeOptions extends Omit<VkCategoryAxisOptions, 'type'>, VkCartesianAxisThemeOptions<VkCategoryAxisOptions> {}
export interface VkGroupedCategoryAxisThemeOptions extends Omit<VkGroupedCategoryAxisOptions, 'type'>, VkCartesianAxisThemeOptions<VkGroupedCategoryAxisOptions> {}
export interface VkTimeAxisThemeOptions extends Omit<VkTimeAxisOptions, 'type'>, VkCartesianAxisThemeOptions<VkTimeAxisOptions> {}
...
export type VkCartesianSeriesMarkerFormatter = (params: VkCartesianSeriesMarkerFormatterParams) => VkCartesianSeriesMarkerFormat;
...
export interface VkOHLCTooltipRendererParams extends VkSeriesTooltipRendererParams {
    dateKey?: string;
    dateName?: string;
...
export interface VkOHLCSeriesTooltip extends VkSeriesTooltip {
    renderer?: (params: VkOHLCTooltipRendererParams) => string | VkTooltipRendererResult;
}

export interface VkOHLCSeriesOptions extends VkBaseSeriesOptions {
    type?: 'ohlc';
    dateKey?: string;
    openKey?: string;
    highKey?: string;
...
export interface VkCartesianChartOptions<TAxisOptions = VkCartesianAxisOptions[], TSeriesOptions = VkCartesianSeriesOptions[]> extends VkBaseChartOptions {
    type?: 'cartesian' | 'groupedCategory' | 'line' | 'bar' | 'column' | 'area' | 'scatter' | 'ohlc';
    axes?: TAxisOptions;
    series?: TSeriesOptions;
}

export interface VkPolarChartOptions<TAxisOptions = VkPolarAxisOptions[], TSeriesOptions = VkPolarSeriesOptions[]> extends VkBaseChartOptions {
    type?: 'polar' | 'pie';
