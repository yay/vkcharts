...
import { VkCartesianChartOptions, VkCartesianSeriesMarkerFormatter, VkChartTheme, VkPolarChartOptions } from "../vkChartOptions";
...
describe("cartesian overrides", () => {
    ...
    const markerFormatter: VkCartesianSeriesMarkerFormatter = () => {
        return {

        };
    };

    const theme: VkChartTheme = {
        baseTheme: 'vk-default',
        palette: {
    ...
    const cartesianChartOptions: VkCartesianChartOptions = {
        theme,
        title: {
            enabled: true,
            text: 'Test Chart',
    ...
    const chart = VkChart.create(cartesianChartOptions);

    test("Options are not mutated after VkChart.create", () => {
...
describe("polar overrides", () => {
    ...
    const polarChartOptions: VkPolarChartOptions = {
        theme,
        title: {
            enabled: true,
            text: 'Test Chart',
    ...
    const chart = VkChart.create(polarChartOptions);
...
describe("common overrides", () => {
    ...
    const cartesianChart = VkChart.create(cartesianChartOptions);
