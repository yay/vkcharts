...
interface VkChartProps {
    options: VkChartOptions;
}

interface VkChartState {

}

class VkChartReact extends React.Component<VkChartProps, VkChartState> {
    constructor(props: VkChartProps) {
        super(props);
    ...
    componentDidMount() {
        this.chart = VkChart.create(this.props.options as VkCartesianChartOptions);
    }

    processPropsChanges(prevProps: Readonly<VkChartProps> & Readonly<{ children?: React.ReactNode }>, nextProps: Readonly<VkChartProps>) {
        VkChart.update(this.chart, nextProps.options);
    }

    shouldComponentUpdate(nextProps: Readonly<VkChartProps>, nextState: Readonly<VkChartState>, nextContext: any): boolean {
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // ReactDOM.render(<VkChartReact width={500} height={500} data={chartData}/>, app);
