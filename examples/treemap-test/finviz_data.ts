  ...
  children: [
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: 'NI', description: 'NiSource Inc.', x: 1170, y: 651, dy: 19, dx: 9 },
            {
              name: 'NRG',
        ...
        },
        {
          ...
          children: [
            { name: 'SCG', description: 'SCANA Corporation', x: 1187, y: 613, dx: 22, dy: 5 },
            {
              name: 'PNW',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: 'PNR', description: 'Pentair plc', x: 1067, y: 626, dy: 21, dx: 8 },
            {
              name: 'PH',
        ...
        },
        {
          ...
          children: [
            { name: 'MAS', description: 'Masco Corporation', x: 1074, y: 611, dx: 29, dy: 10 },
            {
              name: 'MLM',
        ...
        },
        {
          ...
          children: [
            { name: 'PHM', description: 'PulteGroup, Inc.', x: 1044, y: 614, dx: 28, dy: 7 },
            {
              name: 'LEN',
        ...
        },
        {
          ...
          children: [
            { name: 'SRCL', description: 'Stericycle, Inc.', x: 1034, y: 611, dy: 20, dx: 8 },
            {
              name: 'RSG',
        ...
        },
        {
          ...
          children: [
            { name: 'TXT', description: 'Textron Inc.', x: 986, y: 652, dy: 18, dx: 16 },
            {
              name: 'NOC',
        ...
        },
        {
          ...
          children: [
            { name: 'DE', description: 'Deere & Company', x: 979, y: 594, dy: 45, dx: 23 },
            {
              name: 'CAT',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'Drugs - Generic',
          children: [
            { name: 'MYL', description: 'Mylan N.V.', x: 1137, y: 446, dx: 28, dy: 15 },
            {
              name: 'ZTS',
        ...
        },
        {
          ...
          children: [
            { name: 'PKI', description: 'PerkinElmer, Inc.', x: 1201, y: 376, dy: 22, dx: 8 },
            {
              name: 'DGX',
        ...
        },
        {
          ...
          children: [
            { name: 'ABMD', description: 'ABIOMED, Inc.', x: 1168, y: 333, dx: 41, dy: 12 },
            {
              name: 'ZBH',
        ...
        },
        {
          ...
          children: [
            { name: 'CNC', description: 'Centene Corporation', x: 985, y: 447, dx: 40, dy: 14 },
            {
              name: 'ESRX',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: 'FTI', description: 'TechnipFMC plc', x: 1192, y: 48, dy: 20, dx: 17 },
            {
              name: 'NOV',
        ...
        },
        {
          ...
          children: [
            { name: 'FMC', description: 'FMC Corporation', x: 1083, y: 159, dx: 22, dy: 11 },
            {
              name: 'EMN',
        ...
        },
        {
          ...
          children: [
            { name: 'CVX', description: 'Chevron Corporation', x: 839, y: 112, dx: 106, dy: 58 },
            {
              name: 'XOM',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          name: 'Toys & Games',
          children: [
            { name: 'MAT', description: 'Mattel, Inc.', x: 798, y: 632, dy: 19, dx: 6 },
            {
              name: 'HAS',
        ...
        },
        {
          ...
          children: [
            { name: 'NWL', description: 'Newell Brands Inc.', x: 757, y: 657, dx: 24, dy: 13 },
            {
              name: 'CLX',
        ...
        },
        {
          ...
          children: [
            { name: 'OI', description: 'Owens-Illinois, Inc.', x: 743, y: 594, dx: 12, dy: 6 },
            {
              name: 'SEE',
        ...
        },
        {
          name: 'Confectioners',
          children: [
            { name: 'HSY', description: 'The Hershey Company', x: 821, y: 520, dy: 28, dx: 14 },
            {
              name: 'MDLZ',
        ...
        },
        {
          ...
          children: [
            { name: 'HBI', description: 'Hanesbrands Inc.', x: 768, y: 532, dy: 16, dx: 7 },
            {
              name: 'UAA',
        ...
        },
        {
          ...
          children: [
            { name: 'F', description: 'Ford Motor Company', x: 687, y: 638, dy: 32, dx: 27 },
            {
              name: 'GM',
        ...
        },
        {
          ...
          children: [
            { name: 'FOSL', description: 'Fossil Group, Inc.', x: 705, y: 570, dx: 9, dy: 6 },
            {
              name: 'FL',
        ...
        },
        {
          name: 'Cigarettes',
          children: [
            { name: 'MO', description: 'Altria Group, Inc.', x: 762, y: 469, dx: 73, dy: 38 },
            {
              name: 'PM',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: 'KMX', description: 'CarMax, Inc.', x: 790, y: 333, dx: 23, dy: 13 },
            {
              name: 'CPRT',
        ...
        },
        {
          ...
          children: [
            { name: 'FAST', description: 'Fastenal Company', x: 778, y: 292, dy: 22, dx: 17 },
            {
              name: 'GWW',
        ...
        },
        {
          ...
          children: [
            { name: 'M', description: "Macy's, Inc.", x: 690, y: 282, dx: 21, dy: 12 },
            {
              name: 'KSS',
        ...
        },
        {
          name: 'Lodging',
          children: [
            { name: 'EXPE', description: 'Expedia Group, Inc.', x: 818, y: 207, dy: 30, dx: 17 },
            {
              name: 'HLT',
        ...
        },
        {
          name: 'Railroads',
          children: [
            { name: 'KSU', description: 'Kansas City Southern', x: 657, y: 298, dy: 32, dx: 9 },
            {
              name: 'NSC',
        ...
        },
        {
          name: 'CATV Systems',
          children: [
            { name: 'DISCA', description: 'Discovery, Inc.', x: 649, y: 232, dy: 20, dx: 17 },
            {
              name: 'DISH',
        ...
        },
        {
          ...
          children: [
            { name: 'VIAB', description: 'Viacom, Inc.', x: 810, y: 155, dx: 25, dy: 15 },
            {
              name: 'CBS',
        ...
        },
        {
          ...
          children: [
            { name: 'DLTR', description: 'Dollar Tree, Inc.', x: 729, y: 138, dy: 32, dx: 20 },
            {
              name: 'DG',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: 'AIZ', description: 'Assurant, Inc.', x: 403, y: 661, dx: 14, dy: 9 },
            {
              name: 'UNM',
        ...
        },
        {
          ...
          children: [
            { name: 'HCP', description: 'HCP, Inc.', x: 407, y: 614, dy: 23, dx: 10 },
            {
              name: 'VTR',
        ...
        },
        {
          ...
          children: [
            { name: 'VNO', description: 'Vornado Realty Trust', x: 406, y: 560, dy: 41, dx: 7 },
            {
              name: 'AMT',
        ...
        },
        {
          ...
          children: [
            { name: 'LM', description: 'Legg Mason, Inc.', x: 293, y: 606, dx: 10, dy: 7 },
            {
              name: 'JEF',
        ...
        },
        {
          ...
          children: [
            { name: 'NAVI', description: 'Navient Corporation', x: 220, y: 658, dy: 12, dx: 6 },
            {
              name: 'WU',
    ...
    },
    {
      ...
      children: [
        ...
        },
        {
          ...
          children: [
            { name: 'FLIR', description: 'FLIR Systems, Inc.', x: 444, y: 284, dy: 15, dx: 14 },
            {
              name: 'GRMN',
        ...
        },
        {
          ...
          children: [
            { name: 'GLW', description: 'Corning Incorporated', x: 414, y: 231, dy: 28, dx: 20 },
            {
              name: 'APH',
        ...
        },
        {
          ...
          children: [
            { name: 'FSLR', description: 'First Solar, Inc.', x: 436, y: 215, dx: 50, dy: 3 },
            {
              name: 'NVDA',
        ...
        },
        {
          ...
          children: [
            { name: 'XRX', description: 'Xerox Corporation', x: 403, y: 212, dx: 31, dy: 6 },
            {
              name: 'FIS',
        ...
        },
        {
          ...
          children: [
            { name: 'QRVO', description: 'Qorvo, Inc.', x: 471, y: 113, dy: 15, dx: 15 },
            {
              name: 'MCHP',
        ...
        },
        {
          ...
          children: [
            { name: 'TRIP', description: 'TripAdvisor, Inc.', x: 201, y: 210, dy: 22, dx: 15 },
            {
              name: 'AKAM',
