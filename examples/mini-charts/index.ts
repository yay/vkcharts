...
import { type VkChartThemePalette } from '../../lib/main';
import { chartTheme, materialDark, materialLight, pastelDark, pastelLight, solarLight } from './themes';
...
class MiniLine extends MiniChart {
  ...
  updateColors(_fills: string[], strokes: string[]) {
...
class CustomCombo extends MiniChart {
  ...
  constructor(container: HTMLElement, fills: string[], strokes: string[]) {
    ...
    this.penIcon.svgPath =
      'M26.57,59.46l13.65,14m34.39-48a9.71,9.71,0,0,0-13.82,0L26.17,60l-.17.16L22.74,76.36,22.5,77.5,39.81,74l34.8-34.79a9.71,9.71,0,0,0,0-13.82ZM57.46,28.72,71.25,42.57m-15-12.09,13.65,14';
...
const palettesArray: VkChartThemePalette[] = [
  chartTheme,
  materialLight,
  pastelLight,
  solarLight,
