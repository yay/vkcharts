...
document.addEventListener('DOMContentLoaded', () => {
  ...
  delay()
    .then(() => setOp('source-in'))
    .then(delay)
    .then(() => setOp('source-out'))
    .then(delay)
    .then(() => setOp('source-atop'))
    .then(delay)
    .then(() => setOp('destination-over'))
    .then(delay)
    .then(() => setOp('destination-in'))
    .then(delay)
    .then(() => setOp('destination-out'))
    .then(delay)
    .then(() => setOp('destination-atop'))
    .then(delay)
    .then(() => setOp('lighter'))
    .then(delay)
    .then(() => setOp('copy'))
    ...
    .then(() => setOp('lighten'))
    .then(delay)
    .then(() => setOp('color-dodge'))
    .then(delay)
    .then(() => setOp('color-burn'))
    .then(delay)
    .then(() => setOp('hard-light'))
    .then(delay)
    .then(() => setOp('soft-light'))
    .then(delay)
    .then(() => setOp('difference'))
    .then(delay)
    .then(() => setOp('exclusion'))
    .then(delay)
    .then(() => setOp('hue'))
    .then(delay)
    .then(() => setOp('saturation'))
    .then(delay)
    .then(() => setOp('color'))
    .then(delay)
    .then(() => setOp('luminosity'));
